...
export default function VideosPage() {
  const videos = [
    ...
    },
    {
      ...
      description: "Những kỷ niệm tuyệt vời trong chuyến đi Đà Lạt của lớp 9A1",
      thumbnail: "/Imagehs/pxb6.jpg",
      youtubeId: "W4UeUJA9wLU", // Replace with actual YouTube ID
    },
    {
      id: 3,
      title: "Lễ tổng kết năm học",
      description: "Buổi lễ tổng kết năm học đầy xúc động của lớp 9A1",
      thumbnail: "/Imagehs/pxb5.jpg",
      youtubeId: "fQWItghG5dM", // Replace with actual YouTube ID
    },
    {
      id: 4,
      title: "Tiết mục văn nghệ của lớp",
      description: "Tiết mục văn nghệ đặc sắc của lớp 9A1 trong hội diễn văn nghệ trường",
      thumbnail: "/Imagehs/pxb9.jpg",
      youtubeId: "fyMgBQioTLo", // Replace with actual YouTube ID
    },
  ]
        ...
        >
          ...
          <div className="aspect-video">
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/n8mpshmZ1L4?si=RXK1TPENFovgzP4W"
              title="Chuyện Chúng Ta Sau Này - Hai Dang Doo w Weeza"
              frameBorder="0"
